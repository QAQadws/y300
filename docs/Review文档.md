...
### �������̻�����
- [ ] ����������װ�ڶ������ `ReaderZoomableImage`
- [ ] `ComicReaderPage` ������״̬�������ͻЭ��
- [ ] `ReaderTapZones` ����չ���뿪�أ�`enabled`����������ҵ�����

### �ġ����Ը���
- [ ] `test/features/comic/presentation/widgets/reader_zoomable_image_test.dart` ����˫������״̬�л�
- [ ] `test/features/comic/presentation/comic_reader_page_test.dart` �����Ķ�ҳ�����������
- [ ] `test/features/comic/presentation/widgets/reader_tap_zones_test.dart` ���ǽ���̬�����Ч
...
### ��������ʵ�ֽ���
- [ ] ����Ŀ¼�����߼������������ҳ��/��������
- [ ] �Զ��� `CacheManager` �����߼�������factory + file system��
- [ ] comic provider ����װ�䣬������Ŀ¼����ϸ��

### ��������������ȷ��
- [ ] `cacheCurrentEpisode` / `cacheAllUnread` / `prefetch` ����ͬһ cache manager ʵ����Դ
- [ ] `cacheLocalPath` д����ʵ�����ļ�·������ URL��
- [ ] ����ʧ��ʱ״̬��·��д����Ϊһ���ҿ�׷��

### �ġ����Ը���
- [ ] `test/features/comic/data/comic_cache_directory_resolver_test.dart` �����Զ���Ŀ¼����
- [ ] `test/features/comic/presentation/controllers/comic_reader_controller_test.dart` ���Ǳ���·�����
- [ ] �ܽӿ�����Ӱ��� reader ��ز��� fake/override ��ȫ������
...
## subject�ṹ������ Review�����嵥��fid=30��
### һ����������
- [ ] `subject` �����Ѷ���Ϊ `ComicSubjectParser` ���󣬲����ҳ���
- [ ] �������ȡ�������顢���ߺ�ѡ��������ǩ����������
- [ ] ����δ����ʱ���ȶ����ˣ�����ԭʼ���⣬����������̣�
...
### ���������ݽ������
- [ ] `comics` �������� `translation_group` �ֶ�
- [ ] ���ݿ�����Ǩ�ƿɼ��ݾɰ汾��
- [ ] �����ݶ�ȡ���̲��������ֶ��ж�

### �ġ����Ը���
- [ ] `comic_subject_parser_test.dart` ���Ǻ��Ľ�������
- [ ] `local_comic_repository_test.dart` ���Ǳ���/����/������������ȼ�
- [ ] `comic_detail_page_test.dart` ��������ҳ������չʾ
