...
final class YamiboGatewayForumClientNetwork
    implements forum.ForumClientNetwork {
  const YamiboGatewayForumClientNetwork({
...
final class Y300ForumFormhashProvider implements forum.ForumFormhashProvider {
  const Y300ForumFormhashProvider(this._delegate);
...
final class Y300ForumSessionStore implements forum.ForumSessionStore {
  const Y300ForumSessionStore(this._delegate);
...
final class Y300ForumDocumentStore implements forum.ForumDocumentStore {
  const Y300ForumDocumentStore(this._delegate);
...
final class Y300ForumSnapshotStore implements forum.ForumSnapshotStore {
  const Y300ForumSnapshotStore(this._delegate);
