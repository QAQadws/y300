...
/// It does not enter Flutter's gesture arena, so vertical ListView scrolling,
/// PageView swiping and image zoom gestures can keep their native behavior.
...
class _ReaderTapZonesState extends State<ReaderTapZones> {
                  ...
                  children: [
                    Expanded(
                      child: SizedBox.expand(
                        key: Key('comic-reader-left-tap-zone'),
                      ),
                    ),
                    Expanded(
                      child: SizedBox.expand(
                        key: Key('comic-reader-center-tap-zone'),
                      ),
                    ),
                    Expanded(
                      child: SizedBox.expand(
                        key: Key('comic-reader-right-tap-zone'),
                      ),
                    ),
                  ],
                ),
  ...
  void _handlePointerDown(PointerDownEvent event) {
    ...
    // A second tap inside the double-tap window belongs to image zoom. Cancel
    // the delayed reader shortcut so zooming does not also open the menu.
