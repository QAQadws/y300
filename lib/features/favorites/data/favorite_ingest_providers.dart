...
final comicFavoriteIngestServiceProvider =
    Provider<ComicFavoriteIngestService>((ref) {
...
final novelFavoriteIngestServiceProvider =
    Provider<NovelFavoriteIngestService>((ref) {
