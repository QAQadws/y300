  ...
  static String resolve(AppLocalizations l10n, Object? error) {
    if (error case DataReadFailure<dynamic, dynamic>(:final kind)) {
      return switch (kind) {
        ...
        DataReadFailureKind.timeout => l10n.commonTimeoutError,
        DataReadFailureKind.unauthorized => l10n.commonUnauthorizedError,
        DataReadFailureKind.server => l10n.commonServerError,
        DataReadFailureKind.parse => l10n.commonParseError,
        DataReadFailureKind.business ||
        DataReadFailureKind.unsupported => l10n.commonRequestError,
        DataReadFailureKind.cancelled ||
        DataReadFailureKind.unknown => l10n.commonUnknownError,
      };
    }
