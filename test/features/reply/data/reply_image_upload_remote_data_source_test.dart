...
void main() {
  ...
  group('DiscuzReplyImageUploadDioDataSource', () {
    setUp(() {
...
DiscuzReplyImageUploadDioDataSource _buildDataSource(
...
ReplyImageUploadPermission _permission() {
  return const ReplyImageUploadPermission(
    uid: '597454',
