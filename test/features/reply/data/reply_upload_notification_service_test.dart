...
void main() {
  group('FlutterLocalReplyUploadNotificationService', () {
    test('showProgress posts deterministic upload notification', () async {
      final client = _FakeNotificationClient();
      final service = FlutterLocalReplyUploadNotificationService(
        client: client,
      );
    ...
    test('clear cancels reply upload notification', () async {
      final client = _FakeNotificationClient();
      final service = FlutterLocalReplyUploadNotificationService(
        client: client,
      );
