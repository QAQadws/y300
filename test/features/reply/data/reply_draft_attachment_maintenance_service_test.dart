...
void main() {
  ...
  group('SharedPreferencesReplyDraftAttachmentMaintenanceService', () {
    test('sanitizes expired attachments across thread and post drafts', () async {
      final thread = ReplyDraftIdentity.thread(fid: '33', tid: '572063');
      final post = ReplyDraftIdentity.post(
        fid: '33',
        tid: '572063',
        repquote: '41554317',
      );
      ...
      final service = SharedPreferencesReplyDraftAttachmentMaintenanceService(
    ...
    test('deletes only owned cachePath files, not original localPath', () async {
      ...
      final service = SharedPreferencesReplyDraftAttachmentMaintenanceService(
        cacheStorage: LocalReplyUploadCacheStorage(
    ...
    test('removes malformed drafts and reports failures without throwing', () async {
      final identity = ReplyDraftIdentity.thread(fid: '33', tid: '572063');
      SharedPreferences.setMockInitialValues(<String, Object>{
      ...
      final service = SharedPreferencesReplyDraftAttachmentMaintenanceService(
        cacheStorage: _ThrowingReplyUploadCacheStorage(),
        now: () => DateTime.utc(2026, 6, 8, 12),
      );
...
String _rawDraft({
  required ReplyDraftIdentity identity,
...
Map<String, Object?> _rawAttachment({
  ...
  return <String, Object?>{
    ...
    'mimeType': 'image/jpeg',
    'order': 0,
    'status': ReplyImageAttachmentStatus.uploaded.name,
    'aid': aid,
...
class _ThrowingReplyUploadCacheStorage implements ReplyUploadCacheStorage {
  @override
