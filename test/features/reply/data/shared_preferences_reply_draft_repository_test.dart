...
void main() {
  ...
  group('SharedPreferencesReplyDraftRepository', () {
    ...
    test('loadDraft removes expired uploaded attachment and attach line', () async {
      final identity = ReplyDraftIdentity.thread(fid: '33', tid: '572063');
      SharedPreferences.setMockInitialValues(<String, Object>{
        'reply_draft.${identity.storageKey}': _rawDraft(
          identity: identity,
    ...
    test('pruneDrafts sanitizes expired attachments in kept drafts', () async {
      final first = ReplyDraftIdentity.thread(fid: '33', tid: '572063');
      final second = ReplyDraftIdentity.post(
        fid: '33',
        tid: '572063',
        repquote: '41554317',
      );
      ...
      expect((await repository.loadDraft(second))?.imageAttachments, hasLength(1));
    });
  });
}
