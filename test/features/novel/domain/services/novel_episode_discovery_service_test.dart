...
void main() {
  ...
  test('NovelEpisodeDiscoveryService extracts cover, intro and inline images', () {
    const service = NovelEpisodeDiscoveryService();
...
''',
    ...
    expect(plan.episodes.map((e) => e.sourcePid), <String>['39844657', '39845455']);
  ...
  test('NovelEpisodeDiscoveryService falls back to OP post pids when catalog is missing', () {
    const service = NovelEpisodeDiscoveryService();
  ...
  test('NovelEpisodeDiscoveryService recognizes specials and fallback prologue', () {
    const service = NovelEpisodeDiscoveryService();
