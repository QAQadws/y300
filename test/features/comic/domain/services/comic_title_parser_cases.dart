...
final List<ComicTitleAnalyzerCase> stageOneComicTitleAnalyzerCases =
  ...
  const ComicTitleAnalyzerCase(
    ...
    rawTitle:
        '【橋本ライドン】 来签订契约吧!精疲力竭的女子与爱照顾人的恶魔的同居生活 第12话 Kakukuroi汉化组',
    expectedCleanBookName:
        '来签订契约吧!精疲力竭的女子与爱照顾人的恶魔的同居生活',
  ...
  const ComicTitleAnalyzerCase(
    ...
    rawTitle:
        '[汉化工房九九组][玉崎たま]无力圣女与无能王女 ~毫无魔力却被召唤的圣女的异世界救国记~ 16话「阿斯特拉」',
    // `~` 不再被截断或外缘剥离，整个副标题保留下来。
    expectedCleanBookName:
        '无力圣女与无能王女 ~毫无魔力却被召唤的圣女的异世界救国记~',
  ...
  const ComicTitleAnalyzerCase(
    ...
    rawTitle:
        '【汉化工房九九组】[冬島暮]腹黑圣女和她捡来的兽耳邪神，今天也要一起惩治邪恶 第3话',
    expectedCleanBookName:
        '腹黑圣女和她捡来的兽耳邪神，今天也要一起惩治邪恶',
    // 26 runes，超过 18 字阈值。
  ...
  const ComicTitleAnalyzerCase(
    ...
    // `番外` 命中 special marker，截断点在 `番外` 前；`二卷` 留在书名里。
    expectedCleanBookName: 'LOVE·BULLET 二卷',
    expectedSearchKeyword: 'LOVE·BULLET 二卷',
