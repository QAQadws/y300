...
void main() {
  ...
  test('v38 upgrade backfills existing episode titles as source names', () async {
    ...
    final episodes = await repository.getComicEpisodes(comicId: 'legacy-comic');
  ...
  test('v38 upgrade survives a legacy episodes table without a title column', () async {
