...
void main() {
  ...
  group('ComicCoverStore', () {
    ...
    test('updateCoverCache writes normal and custom local cover paths', () async {
      ...
      expect(detail?.customCoverImageUrl, 'https://img.test/custom-cover.jpg');
      expect(detail?.customCoverLocalPath, '/cache/custom-cover.jpg');
    });

    test('promoteFirstEpisodeCover uses smallest tid and preserves custom cover', () async {
      await repository.addToShelf(
        comicId: 'yamibo:700',
        tid: '700',
        fid: '30',
