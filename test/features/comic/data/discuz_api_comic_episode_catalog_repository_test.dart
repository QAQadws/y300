...
void main() {
  test('keeps DOM-first order and attachment identity without duplicates', () async {
  ...
  test('an identified first post with no images is a successful empty catalog', () async {
    final repository = DiscuzApiComicEpisodeCatalogRepository(
      threadRepository: _ThreadRepository(
