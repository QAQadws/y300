...
void main() {
  ...
  test('LocalImageCacheRepository stores protected and unprotected cache records separately', () async {
    const dbName = 'comic_shelf_test_image_cache_repo.db';
    await deleteDatabase(dbName);
    final repository = LocalImageCacheRepository(ComicLocalDb.open(databaseName: dbName));
