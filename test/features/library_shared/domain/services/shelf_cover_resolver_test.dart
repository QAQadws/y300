...
void main() {
  test('ShelfCoverResolver prefers custom local then normal local before cache metadata', () async {
    final resolver = ShelfCoverResolver(
      imageCacheService: _FakeImageCacheService(localPath: '/cache/from-meta.jpg'),
    );
  ...
  test('ShelfCoverResolver returns remote-only without downloading when no local exists', () async {
    final resolver = ShelfCoverResolver();
  ...
  test('ShelfCoverResolver marks cached cover request as stale when metadata misses', () async {
    final resolver = ShelfCoverResolver(
  ...
  test('ShelfCoverResolver marks item remote as stale when cache metadata misses by key', () async {
    final resolver = ShelfCoverResolver(
      imageCacheService: _FakeImageCacheService(),
    );
