...
''',
      ...
      expect(
        sources.map((source) => source.normalizedUrl).toList(),
        <String>[
      ...
      expect(
        sources.map((source) => source.position).toList(),
        <int>[0, 1, 2, 3],
      );
    });
...
''',
    ...
    test('supports attachment image recognition and includeAttachments flag', () {
      final post = ThreadPost(
        pid: '1',
        author: 'op',
        authorId: '100',
    ...
    test('deduplicates DOM and attachment urls with DOM metadata winning first', () {
      final post = ThreadPost(
        pid: '1',
        author: 'op',
        authorId: '100',
